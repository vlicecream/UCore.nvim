...
function M.reset()
	...
	pcall(function()
		require("ucore.unreal_init").reset()
	end)
	pcall(function()
	...
	pcall(function()
		require("ucore.verse").reset()
	end)
	pcall(function()
		require("ucore.shader").reset()
	end)
